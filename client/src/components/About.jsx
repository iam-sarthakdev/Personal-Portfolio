    ...
    return (
        <section id="about" className="section-padding" style={{ position: 'relative' }}>
            ...
            >
                ...
                <p>
                    I have solved <span style={{ color: 'var(--primary-color)', fontWeight: 600 }}>500+ problems on LeetCode</span>, which has strengthened my
                    problem-solving skills and ability to write efficient, maintainable code.
                </p>
            </motion.div>
            ...
            <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem' }}>
                    ...
                    <SkillCategory title="Backend" skills={["Node.js", "Express.js", "REST APIs", "Auth"]} delay={0.2} />
                    <SkillCategory title="Databases" skills={["MongoDB", "MySQL"]} delay={0.3} />
                    <SkillCategory title="DevOps & Tools" skills={["Git", "GitHub", "Docker", "Postman"]} delay={0.4} />
                    <SkillCategory title="Core Concepts" skills={["DSA", "OOP", "DBMS", "OS"]} delay={0.5} />
                </div>
            </div>
        </section>
    );
