...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="relative min-h-screen w-full flex flex-col items-center justify-center text-center px-5 sm:px-8 md:px-10 py-20 bg-[#0C0C0C] overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col items-center gap-10 sm:gap-14 md:gap-16 max-w-4xl mx-auto">
        <FadeIn delay={0} y={40}>
        ...
        <FadeIn delay={0.2} y={20} className="mt-6 sm:mt-8 md:mt-10">
